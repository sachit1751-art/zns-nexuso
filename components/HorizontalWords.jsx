...
const HorizontalWords = () => {
    ...
    return (
        <section ref={sectionRef} className="horizontal-words-section content-section" data-nav-theme="light">
            <div className="horizontal-words__relative">
                <div className="horizontal-words__sticker-svg">
                    ...
                    <img loading="lazy" src="/assets/HorizontalWords SVG/horizontal-words-sticker-thumps-up.svg" className="horizontal-words__sticker-watch" alt="thumbs up sticker" />
                    <img loading="lazy" src="/assets/HorizontalWords SVG/horizontal-words-sticker-cursor.svg" className="horizontal-words__sticker-cursor" alt="cursor sticker" />
                    <img loading="lazy" src="/assets/HorizontalWords SVG/horizontal-words-sticker-phone.svg" className="horizontal-words__sticker-phone" alt="phone sticker" />
                    ...
                    <h2 className="display horizontal-words__h2" aria-label="We wanna be where growth is">
            ...
            <div className="horizontal-words__bottom-text">
                <div className="horizontal-words__bottom-text-l">
                    Audiences are everywhere, yet <em>closer</em> than ever.<br />
                    We help brands master the new mainstream<br />
                    channels to capture attention and lead.
                </div>
            </div>
        </section>
    );
